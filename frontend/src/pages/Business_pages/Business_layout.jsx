...
const Business_layout = () => {
  ...
  return (
    <div>
      ...
      {/* the paages buttons */}
      <div className="fixed bottom-2 w-full border-t border-neutral-200 h-16 flex justify-around items-center">
        {/* dashboard */}
        <Link
        onClick={()=>{
        ...
        {/* add an offer */}
        <div className={`w-1/4 h-full flex justify-center items-center`}><FaPlus size={25}/></div>
