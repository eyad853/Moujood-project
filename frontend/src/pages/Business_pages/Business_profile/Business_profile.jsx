    ...
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="px-5 -mt-12 relative z-10">
        ...
        <div className="bg-white rounded-3xl shadow-lg p-8 mt-6 flex flex-col items-center">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Your Business QR Code</h3>
          <div className="bg-white p-4 rounded-2xl shadow-md">
            <img
              src={userProfile.qrCodeUrl}
              alt="Business QR Code"
              className="w-52 h-52 object-contain"
            />
          </div>
          <p className="text-xs text-gray-500 text-center mt-4 max-w-xs">
            Share this QR code with your customers to let them access your offers quickly
          </p>
        </div>
