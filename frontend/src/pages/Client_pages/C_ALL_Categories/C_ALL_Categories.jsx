...
useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      {/* Content */}
      <div className={`px-5 ${ads.length>0?"py-4":'pb-4 pt-2'}`}>
        {/* Featured Slider */}
        ...
        <div className="grid grid-cols-2 gap-3">
          {filteredCategories.map((category) => (
            ...
            to={`/client/sub_categories/${category.name}/${category.id}`}
              key={category.id}
              className="bg-[#009842] rounded-2xl p-4 flex flex-col items-center justify-center hover:bg-[#007a36] transition-colors aspect-square"
            >
...
export default C_ALL_Categories;